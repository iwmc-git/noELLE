package noelle.features.languages.common.language;
...
public enum Language {
    ...
    public static @NotNull Optional<Language> fromKey(@NotNull LanguageKey key) {
        var valuesList = Arrays.asList(values());
        return valuesList.stream().filter(language -> language.key().equals(key)).findFirst();
    }
}
