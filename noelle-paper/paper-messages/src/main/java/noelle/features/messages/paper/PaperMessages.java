package noelle.features.messages.paper;
...
public class PaperMessages extends AbstractMessages<Player> {

    protected PaperMessages(DefaultConfiguration<?> configuration) {
        super(configuration);
    }

    @Contract("_ -> new")
    public static @NotNull PaperMessages init(DefaultConfiguration<?> configuration) {
        return new PaperMessages(configuration);
    }
