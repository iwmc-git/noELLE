package noelle.features.languages.velocity.translation;
...
public class VelocityTranslation implements Translation {
    private final DefaultConfiguration<?> configuration;
    private final Player player;

    public VelocityTranslation(DefaultConfiguration<?> configuration, Player player) {
